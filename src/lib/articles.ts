...
export const TYPE_COLOR: Record<ArticleType, { bg: string; text: string; border: string }> = {
  "кейс":    { bg: "rgba(212,165,116,0.15)", text: "rgba(255,255,255,0.58)", border: "rgba(212,165,116,0.3)" },
  "статья":  { bg: "rgba(212,165,116,0.15)", text: "#E8C49A", border: "rgba(212,165,116,0.3)" },
  "гайд":    { bg: "rgba(212,165,116,0.15)",  text: "#F5C97A", border: "rgba(212,165,116,0.3)" },
...
export const ARTICLES: ArticleCard[] = [
  {
    ...
    featured: true,
    gradient: "linear-gradient(135deg,rgba(212,165,116,0.3),rgba(212,165,116,0.1))",
  },
  {
    ...
    featured: true,
    gradient: "linear-gradient(135deg,rgba(212,165,116,0.2),rgba(212,165,116,0.05))",
  },
  {
...
export const ALL_ARTICLES = [
  ...
  },
  {
    ...
    featured: true,
    gradient: "linear-gradient(135deg,rgba(212,165,116,0.2),rgba(212,165,116,0.1))",
  },
  {
