...
export function Footer() {
  ...
  return (
    <footer style={{ marginTop: "auto", background: "#0C0A08", position: "relative" }}>
      ...
      <div style={{
        height: "80px",
        background: "linear-gradient(to bottom, transparent, rgba(12,10,8,0.6) 60%, #0C0A08 100%)",
        marginTop: "-80px",
        pointerEvents: "none",
        position: "relative",
        zIndex: 1,
      ...
      <div style={{
        height: "1px",
        background: "linear-gradient(90deg, transparent 0%, rgba(212,165,116,0.22) 30%, rgba(212,165,116,0.4) 50%, rgba(212,165,116,0.22) 70%, transparent 100%)",
      }} />
