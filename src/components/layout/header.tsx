        ...
        {open && (
          ...
          >
            ...
            <div style={{
              ...
              borderRadius: "16px",
              padding: "8px",
              boxShadow: "0 20px 60px rgba(0,0,0,0.55), 0 0 0 1px rgba(212,165,116,0.07)",
              ...
              {item.children.map((child, i) => (
                <Link
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = "rgba(212,165,116,0.09)"; }}
                  onMouseLeave={e => { e.currentTarget.style.background = "transparent"; }}
                >
                  {/* Иконка */}
                  <div style={{
                    width: "36px", height: "36px", borderRadius: "10px", flexShrink: 0,
                    background: "rgba(212,165,116,0.08)", border: "1px solid rgba(212,165,116,0.16)",
    ...
    <>
      <header
        style={{
          ...
          background: scrolled ? "rgba(12,10,8,0.92)" : "transparent",
